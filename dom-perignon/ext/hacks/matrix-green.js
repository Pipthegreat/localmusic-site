...
(function () {
  ...
  async function init() {
    ...
    const url = NS.getCSSURL('hacks/matrix-green.css');
  ...
  // Seamless-loop column rain: each column is 200vh tall with its
  // glyph stream duplicated (top half == bottom half). Translating
  // exactly 100vh per cycle has no visible reset.
  ...
  NS.hacks['matrix-green'] = { init, teardown };
})();
